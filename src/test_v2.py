...
def main(params):
    ...
    # # 2025.07.05: Overwrite some paths
    # if params['attack_sarsa_network'] is not None:
    #     params['attack_sarsa_network'] = os.path.join(params['out_dir'], params['exp_id'], params['attack_sarsa_network'])
    # if params['sarsa_model_path'] is not None:
    #     params['sarsa_model_path'] = os.path.join(params['out_dir'], params['exp_id'], params['sarsa_model_path'])
    ...
    # 2025.07.06
    if p.params.ATTACK_SARSA_NETWORK is not None:
        p.params.ATTACK_SARSA_NETWORK = os.path.join(p.params.OUT_DIR, params['exp_id'], p.params.ATTACK_SARSA_NETWORK)
    ...
    if params['sarsa_enable']:
        ...
        save_result_dict = {
            ...
            'all_lens' : all_lens,
            'all_kl_certificates' : all_kl_certificates
        }
        with open(os.path.join(save_path, f'eval_results.json'), 'w') as f:
