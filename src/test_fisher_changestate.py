...
from src.run_changestates import TrainerWithCustomStateSpaceEnv
...
def test_fisher(p: TrainerWithCustomStateSpaceEnv):
...
def load_trainer(params):
    ...
    if "load_model" in params and params["load_model"]:
        ...
        p = TrainerWithCustomStateSpaceEnv.agent_from_params(params, store=None)
        ...
        if params["cpu"] == None:
            ...
            cpu = params["cpu"]
        p, _ = TrainerWithCustomStateSpaceEnv.agent_from_data(
            store,
            row,
            cpu,
            extra_params=params,
...
def run_test(p: TrainerWithCustomStateSpaceEnv):
    import time
